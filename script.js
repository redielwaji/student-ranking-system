...
function editStudent(index) {
  ...
  document.getElementById("nilaiMatematika").value = siswa.nilaiMatematika;
  document.getElementById("nilaiBahasaInggris").value =
  ...
  // Ubah tombol submit
  document.getElementById("submitButton").textContent = "Update Data Siswa";
...
function cancelEdit() {
  ...
  document.getElementById("submitButton").textContent = "Simpan Data Siswa";
